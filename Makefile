...
build: stack.o general.o bmp_parser.o canvas.o collage.o find_max_rect.o line_draw.o rectangle.o triangle.o \
	commands.o helpmenu.o parse_collage.o parse_find_rect.o parse_triangle.o command_parser.o main.o
	$(COMPILER) stack.o general.o bmp_parser.o canvas.o collage.o find_max_rect.o line_draw.o rectangle.o triangle.o \
            commands.o helpmenu.o parse_collage.o parse_find_rect.o parse_triangle.o command_parser.o main.o -o bmpp -lm
...
parse_collage.o: CLI/parse_collage.c CLI/parse_collage.h CLI/commands.h CLI/helpmenu.h Image/collage.h Image/canvas.h
